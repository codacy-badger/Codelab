<section id="clSection_<?php echo $clSection['id']; ?>" class="clSection baner" >
        <div class="fullPageForm">
            <div class="container parallaxFade">
                ...
                <div class="left">
                    <h3 class="hdr">A new look at <span>project management</span></h3>
                    <h6 class="hdr">"Easily plan, organize, collaborate and deliver projects in one place. We helps you save time and deliver value faster.</h6>
                </div>

                <div class="right">
                    <div class="form">
                        <form action="/login" id="loginForm" class="loginForm" method="post">
                            <div class="top">
                                <div class="header">
                                    Sign in
                                </div>
                        ...
                        <form action="/join" id="joinForm" class="joinForm" method="post">
                            <div class="top">
                                <div class="header">
                                    Start for free
                                </div>
                                <div class="subheader">
                                    Create your <strong>psyll.starter</strong> account now
                                </div>
                            </div>
                            <div class="inputs">
                                <div class="input">
                                ...
                                <div class="terms">
                                    <label>
                                        <input  type="checkbox" name="regulations" required/> By clicking 'Sign Up', I agree to all listed below
                                    </label>
                                    <ul>
