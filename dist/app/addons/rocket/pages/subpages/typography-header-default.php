    ...
    <div class="r_c">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li><a href="#">Deafult</a></li>
            </ul>
        </div>
        <div class="example">
            <pre><?php echo htmlentities('<h1>TEXT</h1> or <div class="h1">TEXT</div>');  ?></pre>
        </div>
        <div class="content">
            <h1>This is h1 header example</h1>
            <div class="h2">This is div.h2 header example</div>
        ...
        <div class="content">
            ...
            <div class="h2">This is div.h2 header example. Lorem ipsum dolor sit amet, eu veri lorem albucius eos. Qui dolor invenire. Ne soluta expetendis ius, lobortis deseruisse definiebas eu eos, an melius albucius vis.</div>
